...
with app.app_context():
    ...
    if academy:
        ...
        academy.ai_context = """
        Somos BJJ Santo Domingo, la academia líder de Brazilian Jiu-Jitsu en Costa Rica.
        ...
        academy.description = "Academia líder de Brazilian Jiu-Jitsu en Santo Domingo de Heredia, Costa Rica. Clases para todos los niveles y edades. ¡Primera clase GRATIS!"
